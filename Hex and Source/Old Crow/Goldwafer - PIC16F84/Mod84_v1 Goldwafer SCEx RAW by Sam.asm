...
;
;
;       16F84 Goldwafer version of P1.01B 
;       modified by Sam aka Selfboot Killer on 28-NOV-03
;       uses RAW representation of SCEx boot code
;
...
;       P1.GW   on 28-NOV-03    ;code edited for 16F84 Goldwafer smartcard
;
;
...
dy_0    movlw   -130            ;Preset counter (counting 130 8us ticks)
;                               ;changed from formerly 125 to 130,
;                               ;with 125 Goldwafer does not boot!
