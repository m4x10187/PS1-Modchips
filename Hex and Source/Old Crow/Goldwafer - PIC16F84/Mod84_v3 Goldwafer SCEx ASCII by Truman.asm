...
;
;
;       16F84 Goldwafer version of P1.053 
;       modified by Truman aka CDfreaks Expert on 20-NOV-03
;       uses ASCII representation of SCEx boot code
;
;       Modified for 16f84 and making RB7 as SCEx output.
;       RB1 still remain as before.
;
;
;       Formerly PIC16C84 version of the "v5.2" serial data chip emulation.
...
;       P3.GW   on 20-NOV-03    ;code edited for 16F84 Goldwafer smartcard
;
